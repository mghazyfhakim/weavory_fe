                    ...
                    <div>
                        ...
                        <div className="mt-8 space-y-5 text-sm">
                            <div className="flex justify-between max-w-sm">
                                ...
                                <span className="text-slate-800">{data.material}</span>
                            </div>

                            <div className="flex justify-between max-w-sm">
                                <span className="text-slate-500">Teknik Jahit</span>
                                <span className="text-slate-800">{data.teknik_jahit}</span>
                            </div>

                            <div className="flex justify-between max-w-sm">
                                <span className="text-slate-500">Finishing</span>
                                <span className="text-slate-800">{data.finishing}</span>
                            </div>

                            <div className="flex justify-between max-w-sm">
                                <span className="text-slate-500">Layanan</span>
                                <span className="text-slate-800">{data.layanan}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="mt-4 flex gap-2">
                            {images.map((_, i) => (
                                <div
                                    key={i}
                                    className={`h-2 w-2 rounded-full ${i === currentIndex
                                            ? "bg-[#173A8A]"
                                            : "bg-gray-300"
                                        }`}
                                />
